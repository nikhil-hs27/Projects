...
🌟 **Machine Learning Engineer | Data Scientist | Quantitative Finance**  

Welcome to my GitHub profile, where I showcase my journey in machine learning, data science, and quantitative finance. Dive into projects that highlight my expertise in building intelligent systems, scalable data pipelines, and real-world applications.


## 🔍 **About Me**  
- 📍 Based in Melbourne, Australia  
- 🎓 Master's in Data Science | La Trobe University  
- 💡 Passionate about developing data-driven solutions and exploring cutting-edge technologies like Large Language Models (LLMs). 
- 📧 [Contact Me](mailto:nikhil.wm27@gmail.com)  



## 📌 **Highlighted Projects**  

### 🚀 [Neural Network Optimization](https://github.com/nikhil-hs27/Projects/tree/main/Neural-Network-Optimization)
...
### 💬 [Text Classification & Chatbot Development](https://github.com/nikhil-hs27/Projects/tree/main/Text-Classification-and-Chatbot-Development)
...
### 📈 [Quantitative Finance Strategy: 3-Day Price Change Strategy](https://github.com/nikhil-hs27/Projects/tree/main/Quantitative-Finance)
...
### 📈 [Quantitative Finance Strategy: Statistical Arbitrage](https://github.com/nikhil-hs27/Projects/tree/main/Quantitative-Finance)
...
### 📊 [Scalable Genomics Database Implementation](https://github.com/nikhil-hs27/Projects/tree/main/Scalable-Genomics-Database-Implementation)
...
### 🖥️ [Deep Learning Classifier Tuning](https://github.com/nikhil-hs27/Projects/tree/main/Deep-Learning-Classifier-Tuning)
...
Developed VaR computation models in Python, R, and Excel to assess financial portfolio risks.  
- **Skills Used:** Python, R, Financial Analytics, Statistical Modeling  
- **Key Achievements:** Delivered a tool for daily risk analysis, supporting investment decisions.  

## 🛠️ **Technical Skills**  
### Programming Languages  
- **Python** (TensorFlow, PyTorch, Pandas, NumPy)  
- **R**, SQL, VBA Macros, JavaScript (Basic)  

### Data Science & Machine Learning  
- NLP, Time Series Analysis, Statistical Modeling, Hyperparameter Tuning  

### Tools & Frameworks  
- MongoDB, Tableau, Power BI, Git  


## 🎯 **How to Navigate My Profile**  
- **Explore Individual Repositories:** Each project has a detailed README explaining its purpose, implementation, and results.  
- **Pinned Repositories:** Check out my top projects pinned to this profile for a quick overview of my work.
- **Contact Me:** If you’re interested in collaboration or have questions, feel free to reach out!  
